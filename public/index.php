...
if (isset($_GET['toCart'])) {
    ...
    if (is_numeric($_GET['toCart'])) {
        $toCart = $_GET['toCart'];
        if (isset($_SESSION['id'])) {
            $user_id = $_SESSION['id'];
            $quantity = 1;
            $date = date('Y-m-d h:i:s');
            $sql = "INSERT INTO invoice (user_id,item_id,date_adding,quantity) values ($user_id,$toCart,'$date',$quantity)";
        } else {
            $gaccount_id = $_SESSION['google_account'];
            $quantity = 1;
            $date = date('Y-m-d h:i:s');
            $sql = "INSERT INTO invoice (gaccount_id,item_id,date_adding,quantity) values ($gaccount_id,$toCart,'$date',$quantity)";
        }
...
$sql = "SELECT * from items where is_delete = 0 and quantity>0 order by create_at DESC";
                        ...
                        <div class="hero-slider-active slick-arrow-style slick-arrow-style_hero slick-dot-style">
                            ...
                            ?>
                                        <div class="hero-single-slide">
                                            <div class="hero-slider-item bg-img" style="background-color: #e3a51e;">
                                                <div class="hero-slider-content slide-1">
                                                    <h5 class="slide-subtitle">New Items!</h5>
                                                    <div style="width: 450px; height: 140px; overflow: hidden;">
                                                        <h2 style="width: 450px;" class="slide-title"><?= $rows['name'] ?></h2>
                                                    </div>
                                                    <div style="width: 450px; height: 140px; overflow: hidden; display: inline-block;">
                                                        <textarea disabled style="resize: none;width: 100%; height: 140px; background: none; border: none; overflow-y: hidden;" class="slide-desc"><?= $rows['details'] ?></textarea>
                                                    </div>
                                                    <a href="product.php?id=<?= $rows['id'] ?>" class="btn btn-hero">SHOP NOW</a>
                                                </div>
                                                <div class="img" style="display: inline-block;">
                                                    <img style="width: 550px;height: 470px" src="../uploades/<?= $rows['image'] ?>" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    <?php
                                    ...
                                    ?>
                                        <div class="hero-single-slide">
                                            <div class="hero-slider-item bg-img" style="background-color: #20c997;">
                                                <div class="hero-slider-content slide-1">
                                                    <h5 class="slide-subtitle">New Items!</h5>
                                                    <div style="width: 450px; height: 140px; overflow: hidden;">
                                                        <h2 style="width: 450px;" class="slide-title"><?= $rows['name'] ?></h2>
                                                    ...
                                                    <div style="width: 450px; height: 140px; overflow: hidden; display: inline-block;">
                                                        <textarea disabled style="resize: none;width: 100%; height: 140px; background: none; border: none; overflow-y: hidden;" class="slide-desc"><?= $rows['details'] ?></textarea>
                                                    </div> <a href="product.php?id=<?= $rows['id'] ?>" class="btn btn-hero">SHOP NOW</a>
                                                </div>
                                                <div class="img" style="display: inline-block;">
                                                    <img style="width: 550px;height: 470px" src="../uploades/<?= $rows['image'] ?>" alt="">
                                                </div>
                                    ...
                                    <div class="product-item mb-50">
                                        <div class="product-thumb">
                                            <a href="product-details.html">
                                                <img style="width: 268px;height: 179px;" src="../uploades/<?= $rows['image'] ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="product-content">
                                            <h5 class="product-name" style="width: 190px;max-height: 22px; overflow: hidden;">
                                                <a href="product-details.html"><?= $rows['name'] ?></a>
                                            </h5>
                                            <div class="price-box">
                                                <?php
                                                if (!is_null($rows['discount'])) {
                                                ?>
                                                    <span class="price-regular">$<?php echo $rows['price'] - $rows['discount'] ?></span>
                                                    <span class="price-old"><del>$<?= $rows['price'] ?></del></span>
                                                <?php
                                                } else {
                                                ?>
                                                    <span class="price-regular">$<?php echo $rows['price'] ?></span>
                                                <?php
                                                }
                                                ?>
                                            ...
                                            <div class="product-action-link">
                                                ...
                                                <a href="index.php?toCart=<?= $rows['id'] ?>" data-toggle="tooltip" title="Add To Cart"><i class="ion-bag"></i></a>
                                                <a href="product.php?id=<?= $rows['id'] ?>"><i class="ion-ios-eye-outline"></i> </a>
                                            </div>
                                        </div>
                                    </div>
                            <?php
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title text-center">
                            ...
                            <p class="sub-title">The project is a website for an online store that displays computer accessories such as: mouse, keyboards, headphones and many other products ,It includes several pages containing product details and prices</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <img src="assets/img/gigabyte-aorus-componets.jpg" alt="">
                    </div>
                </div>
            </div>
        </section>
